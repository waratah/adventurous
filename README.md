...
<a href="https://nx.dev" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/nrwl/nx/master/images/nx-logo.png" alt='go to NX' width="45"></a>
...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/l773i1vEin)
...
```sh
npx nx serve score-card
```

To create a production bundle:

```sh
npx nx build score-card
```

To see all available targets to run for a project, run:

```sh
npx nx show project score-card
```
